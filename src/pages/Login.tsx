...
//         {/* Left Side: Image */}
//         <div className="lg:w-1/2 bg-gradient-to-br from-orange-500/20 to-pink-600/20 relative ">
//           <img
...
//                 disabled={loading}
//                 className="w-full pl-10 pr-4 py-3 bg-zinc-800/50 border border-zinc-600 rounded-xl text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-transparent transition-all disabled:opacity-50"
...
//                 disabled={loading}
//                 className="w-full pl-10 pr-10 py-3 bg-zinc-800/50 border border-zinc-600 rounded-xl text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-transparent transition-all disabled:opacity-50"
...
//               type="submit"
//               disabled={loading}
//               className="w-full bg-gradient-to-r from-orange-500 via-red-600 to-pink-600 text-white py-3 rounded-xl font-semibold hover:opacity-90 transition-all duration-300 shadow-lg shadow-orange-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
//             >
